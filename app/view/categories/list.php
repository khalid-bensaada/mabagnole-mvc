                        ...
                        <div
                            ...
                            <div class="relative h-48 bg-gray-200">
                                <img src="https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=500&q=80"
                                    alt="<?= htmlspecialchars($c['modele']) ?>" class="w-full h-full object-cover">
                            ...
                            <div class="p-5">
                                <div class="flex justify-between items-start mb-2">
                                    <h4 class="text-xl font-bold text-gray-800"><?= htmlspecialchars($c['modele']) ?></h4>
                                    <span class="text-blue-600 font-extrabold"><?= number_format($c['prix'], 2) ?> <span
                                            class="text-xs text-gray-400">MAD / jour</span></span>
                                </div>

                                <p class="text-gray-500 text-sm mb-4">Category: <span
                                        class="font-medium"><?= htmlspecialchars($c['categorie']) ?></span></p>
